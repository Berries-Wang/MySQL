...
2. 在文件夹A下执行make
   > 参照编译脚本即可: 001.SOURCE_CODE/build/000.build-scripts/000.MySQL-Build.sh
...
---
## 编译环境创建步骤(源码调试环境搭建)
&nbsp;&nbsp;如编译脚本: 001.SOURCE_CODE/build/000.build-scripts/000.MySQL-Build.sh (内有注释)，本脚本的作用是编译MySQL源代码，并初始化数据库，并启动服务(为什么初始化和启动要写在这里?后面解释)

&nbsp;&nbsp;目录介绍:
```txt
 wei@Wang:~/workspace/SOURCE_CODE/MySQL/001.SOURCE_CODE$ tree build/
 build/  # 编译&&调试文件根目录
...
```log
   ...
   2022-09-04T00:56:17.664718+08:00 0 [Note] InnoDB: Loading buffer pool(s) from /home/wei/workspace/SOURCE_CODE/MySQL/001.SOURCE_CODE/build/000.build-scripts/data/ib_buffer_pool
       ...
       "configurations": [
           {
               ...
               "args": [
                   "--defaults-file=/home/wei/workspace/SOURCE_CODE/MySQL/001.SOURCE_CODE/build/000.build-scripts/sys/my.cnf",
                   "--user=root",
                   "--lc-messages-dir=/home/wei/workspace/SOURCE_CODE/MySQL/001.SOURCE_CODE/build/001.build-output/sql/share"
               ]
           }
       ]
    }
