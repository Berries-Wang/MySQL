...
### gcc & g++
```txt
    sudo update-alternatives --install /usr/bin/clang clang /usr/bin/clang 1 --slave /usr/bin/clang++ clang++ /usr/bin/clang++
...
```txt
   ...
   解决: 使用了较低版本的gcc-10,使用gcc-11无此问题
