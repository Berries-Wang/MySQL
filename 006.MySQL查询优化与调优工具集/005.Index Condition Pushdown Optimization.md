...
&nbsp;&nbsp;To understand how this optimization works, first consider how an index scan proceeds when Index Condition Pushdown is not used:(**没有使用Index Condition Pushdown，扫描过程如下:**)
