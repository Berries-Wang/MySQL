...
3. [Tracing the Optimizer](https://dev.mysql.com/doc/dev/mysql-server/latest/PAGE_OPT_TRACE.html) OR [016.MySQL_ The Optimizer Trace.pdf](./016.MySQL_%20The%20Optimizer%20Trace.pdf)