...
+ MySQL provides a built-in full-text ngram parser that supports Chinese, Japanese, and Korean (CJK), and an installable MeCab full-text parser plugin for Japanese. Parsing differences are outlined in  [“ngram Full-Text Parser”](#分词器), and [“MeCab Full-Text Parser Plugin”](#分词器).(全文解析器)
...
## 分词器
1. [ngram Full-Text Parser](https://dev.mysql.com/doc/refman/8.0/en/fulltext-search-ngram.html) 支持中文解析
2. [ MeCab Full-Text Parser Plugin](https://dev.mysql.com/doc/refman/8.0/en/fulltext-search-mecab.html) 支持解析日文
