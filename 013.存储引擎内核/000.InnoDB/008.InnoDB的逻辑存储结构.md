...
&nbsp;&nbsp;如上图，Compact行记录格式：
1. 首部是一个非NULL变长长度列表<sup>每个varchar字段的长度均会在此描述他的长度</sup>，按照列的顺序逆序放置，长度<sup>单个varchar字段的长度</sup>为:
...
```txt
  ...
  # 测试
    ...
    000100d0  03 01 06 00 00 20 ff 98  00 00 00 00 02 02 00 00  |..... ..........|
    000100e0  00 00 27 1e 82 00 00 01  1d 01 10 64 66 66 66 00  |..'........dfff.|

    第一行数据从0000c078开始，整理如下:
