...
```txt
  ...
  *************************** 1. row ***************************
  ...
  000100e0  14 13 0c 06 00 00 20 0f  00 74 00 00 00 00 04 03  |...... ..t......|
  000100f0  00 00 00 00 2b 22 82 00  00 01 0f 01 10 64 00 00  |....+".......d..|
  00010100  00 00 00 00 00 00 00 00  66 66 66 00 00 00 00 00  |........fff.....|

  数据从0x0001007D 开始，解析如下:
  23 20 16 14 13 0c 06     // 长度偏移列表,逆序
  00 00 10 0f 00 ba        // Record Header ,固定6字节
  ...
  // 计算第二行数据next_record地址:0x000100ad != 0x00010088 + 0x00ba
