...
```txt
  ...
  *************************** 1. row ***************************
  ...
  00 00 10 0f 00 ba        // Record Header ,固定6字节 ==> 可以发现，0x000100ba 是下一行列数据的开始位置
  ...
  00 00 18 0f 00 ea            // ==> 可以发现，0x000100ea 是下一行列数据的开始位置
  00 00 00 00 04 01
  00 00 00 00 2b 1c
  ...
  00 00 20 0f 01 18          // ==> 可以发现，0x00010118 是下一行列数据的开始位置
  00 00 00 00 04 03
  00 00 00 00 2b 22
